...
A ferramenta de build utilizada foi o ***[Apache Maven](https://maven.apache.org/)***.
...
Simplesmente vá para o diretório onde está o arquivo *pom.xml* e digite na linha de comando ```mvn package```, será gerado o diretório "*target*", onde estará o arquivo *jatexteditor-1.0.jar*, só executar o arquivo jar e pronto.